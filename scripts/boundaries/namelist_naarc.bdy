...
!  grid information
!------------------------------------------------------------------------------
   sn_src_hgr = './GOSI10p3_mesh_mask.nc'
   sn_src_zgr = './GOSI10p3_mesh_mask.nc'
   sn_dst_hgr = './domain_cfg_mes.nc'     ! Expects vars found in domain_cfg.nc
   sn_dst_zgr = './domain_cfg_mes.nc'     ! Expects vars: {e3u,e3v,e3w,e3t,nav_lat,nav_lon,mbathy}
   sn_src_msk = './GOSI10p3_mesh_mask.nc'
   sn_bathy   = './remade_bathy.nc'    ! dst bathymetry w/o time dimension
...
!  I/O
!------------------------------------------------------------------------------
   sn_src_dir = './src_data_naarc.ncml' ! src_files/'
   sn_dst_dir = './outputs'
   sn_fn      = 'naarc'             ! prefix for output files
   nn_fv      = -1e20                 !  set fill value for output files
   nn_src_time_adj = 0                ! src time adjustment
   sn_dst_metainfo = 'naarc test'  ! history info
...
!------------------------------------------------------------------------------
    ...
    cn_mask_file   = './pybdy_mask_CANARI.nc'            !  name of mask file
...
!------------------------------------------------------------------------------
    sn_date_start   = '1979-01-17'    !  dst output date start YYYY-MM-DD
    sn_date_end     = '1979-01-20'    !  dst output date end YYYY-MM-DD
